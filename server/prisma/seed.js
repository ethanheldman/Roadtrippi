...
const ROADSIDE_AMERICA = {
    ...
    "World's Largest Ball of Twine": {
        ...
        imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/World%27s_Largest_Ball_of_Twine_-_Cawker_City_-_Kansas.jpg/800px-World%27s_Largest_Ball_of_Twine_-_Cawker_City_-_Kansas.jpg",
    },
    "Lucy the Elephant": {
        sourceUrl: "https://www.roadsideamerica.com/story/14429",
...
const SAMPLE_ATTRACTIONS = [
    { name: "World's Largest Ball of Twine", city: "Cawker City", state: "KS", description: "A massive ball of twine started by Frank Stoeber in 1953. Visitors can add their own twine.", latitude: 39.5092, longitude: -98.4334, address: "Main St, Cawker City, KS" },
    { name: "Cadillac Ranch", city: "Amarillo", state: "TX", description: "Ten Cadillacs half-buried nose-down in a wheat field. Bring spray paint—graffiti is encouraged.", latitude: 35.1850, longitude: -101.9898, address: "I-40 Frontage Rd, Amarillo, TX" },
    { name: "Mystery Spot", city: "Santa Cruz", state: "CA", description: "Gravity-defying cabin and optical illusions. Balls roll uphill; visitors lean at impossible angles.", latitude: 37.0166, longitude: -121.9769, address: "465 Mystery Spot Rd, Santa Cruz, CA" },
    ...
    { name: "Salem Sue", city: "New Salem", state: "ND", description: "World's largest Holstein cow statue. Visible from I-94, standing 38 feet tall.", latitude: 46.8433, longitude: -101.4119 },
    { name: "Paul Bunyan and Babe the Blue Ox", city: "Bemidji", state: "MN", description: "Giant statues of the lumberjack and his ox. A classic roadside photo op since 1937.", latitude: 47.4736, longitude: -94.8803, address: "Paul Bunyan Dr, Bemidji, MN" },
    { name: "Spam Museum", city: "Austin", state: "MN", description: "Museum dedicated to Spam canned meat. Free admission, interactive exhibits, and a gift shop.", latitude: 43.6666, longitude: -92.9746, address: "101 3rd Ave NE, Austin, MN" },
    { name: "Carhenge", city: "Alliance", state: "NE", description: "Stonehenge replica made from vintage cars. Gray-painted cars arranged in a circle.", latitude: 42.1253, longitude: -102.8713, address: "Carhenge Rd, Alliance, NE" },
    { name: "World's Largest Thermometer", city: "Baker", state: "CA", description: "134-foot thermometer in the desert. Built to celebrate the area's record heat.", latitude: 35.2653, longitude: -116.0753 },
    { name: "Lucy the Elephant", city: "Margate City", state: "NJ", description: "Six-story elephant-shaped building. National Historic Landmark; tours available.", latitude: 39.3418, longitude: -74.5032, address: "9200 Atlantic Ave, Margate City, NJ" },
    { name: "Fremont Troll", city: "Seattle", state: "WA", description: "Giant troll sculpture under the Aurora Bridge. Crushing a real VW Beetle.", latitude: 47.6510, longitude: -122.3473, address: "N 36th St, Seattle, WA" },
    { name: "World's Largest Pistachio", city: "Alamogordo", state: "NM", description: "30-foot pistachio statue at a nut farm. Part of McGinn's PistachioTree Ranch.", latitude: 32.8998, longitude: -105.9603 },
    { name: "Foamhenge", city: "Natural Bridge", state: "VA", description: "Full-size Stonehenge replica made of foam. Same dimensions as the original.", latitude: 37.6276, longitude: -79.5439 },
    { name: "Giant Muskie", city: "Hayward", state: "WI", description: "Huge fiberglass muskie statue. Weighs thousands of pounds; symbol of the area.", latitude: 46.0130, longitude: -91.4849 },
    { name: "Corn Palace", city: "Mitchell", state: "SD", description: "Building decorated with murals made of corn. Designs change annually.", latitude: 43.7094, longitude: -98.0298, address: "604 N Main St, Mitchell, SD" },
    { name: "Enchanted Highway", city: "Regent", state: "ND", description: "32-mile stretch with giant scrap metal sculptures. Geese in Flight, Tin Family, and more.", latitude: 46.4211, longitude: -102.5521 },
    { name: "World's Largest Catsup Bottle", city: "Collinsville", state: "IL", description: "170-foot water tower shaped like a ketchup bottle. Restored by community effort.", latitude: 38.6703, longitude: -89.9845 },
    { name: "Salvation Mountain", city: "Niland", state: "CA", description: "Colorful folk art mountain in the desert. Built by Leonard Knight with adobe and paint.", latitude: 33.2522, longitude: -115.4753 },
    { name: "World's Largest Peanut", city: "Ashburn", state: "GA", description: "Giant peanut monument. Celebrates the peanut capital of the world.", latitude: 31.7060, longitude: -83.6532 },
    { name: "Giant Paul Bunyan", city: "Bangor", state: "ME", description: "31-foot statue of Paul Bunyan. Holding an axe and a peavey.", latitude: 44.8012, longitude: -68.7778 },
    ...
    { name: "Cabazon Dinosaurs", city: "Cabazon", state: "CA", description: "Giant dinosaur statues visible from I-10. Dinny the dinosaur and a T-rex; gift shop inside.", latitude: 33.9172, longitude: -116.7870, address: "50770 Seminole Dr, Cabazon, CA" },
    { name: "World's Largest Buffalo", city: "Jamestown", state: "ND", description: "26-foot-tall concrete buffalo statue. Stands at the entrance to the National Buffalo Museum.", latitude: 46.9102, longitude: -98.7084 },
    ...
    { name: "Blue Whale of Catoosa", city: "Catoosa", state: "OK", description: "Giant blue whale structure on Route 66. Built as a surprise anniversary gift; now a swimming hole landmark.", latitude: 36.1881, longitude: -95.7458 },
    { name: "World's Largest Fork", city: "Springfield", state: "MO", description: "35-foot fork standing beside a restaurant. Made of stainless steel.", latitude: 37.2153, longitude: -93.2982 },
    { name: "Jolly Green Giant", city: "Blue Earth", state: "MN", description: "55-foot statue of the Green Giant. Visible from I-90; photo op with the iconic figure.", latitude: 43.6377, longitude: -94.1022 },
    { name: "World's Largest Ball of Paint", city: "Alexandria", state: "IN", description: "A baseball coated with thousands of layers of paint. Visitors can add a layer.", latitude: 40.2628, longitude: -85.6761 },
    { name: "Giant Coffee Pot", city: "Bedford", state: "PA", description: "Historic roadside coffee pot building. Built in 1927 as a diner.", latitude: 40.0187, longitude: -78.5036 },
    { name: "World's Largest Pecan", city: "Seguin", state: "TX", description: "Giant pecan statue. Celebrates the area's pecan industry.", latitude: 29.5688, longitude: -97.9647 },
    { name: "Muffler Man (Uncle Sam)", city: "Las Vegas", state: "NV", description: "Giant fiberglass Uncle Sam holding a hot dog. Classic roadside statue.", latitude: 36.1699, longitude: -115.1398 },
    { name: "World's Largest Frying Pan", city: "Long Beach", state: "WA", description: "Giant frying pan. Part of the town's annual Razor Clam Festival history.", latitude: 46.3521, longitude: -124.0543 },
    { name: "Giant Abraham Lincoln", city: "Dixon", state: "IL", description: "Statue of young Lincoln. Lincoln grew up in the area; statue depicts him as a rail-splitter.", latitude: 41.8436, longitude: -89.4815 },
    { name: "World's Largest Mailbox", city: "Casey", state: "IL", description: "Oversized mailbox. One of several 'world's largest' items in the town of Casey.", latitude: 39.2992, longitude: -87.9925 },
    { name: "Salem Witch Trial Memorial", city: "Salem", state: "MA", description: "Memorial to those accused in the witch trials. Solemn stone benches with victims' names.", latitude: 42.5218, longitude: -70.8967 },
    { name: "World's Largest Rubber Stamp", city: "Cleveland", state: "OH", description: "Giant rubber stamp sculpture. Part of the city's public art collection.", latitude: 41.5055, longitude: -81.6813 },
    { name: "Giant Peanut (Mr. Peanut)", city: "Suffolk", state: "VA", description: "Giant Mr. Peanut statue. Planters Peanuts was founded nearby.", latitude: 36.7282, longitude: -76.5836 },
    { name: "World's Largest Cuckoo Clock", city: "Sugarcreek", state: "OH", description: "Giant cuckoo clock that chimes. Swiss-themed town attraction.", latitude: 40.5034, longitude: -81.6410 },
    { name: "World's Largest Stiletto", city: "Philadelphia", state: "PA", description: "Giant high-heel shoe sculpture. Part of the city's quirky public art.", latitude: 39.9526, longitude: -75.1652 },
    { name: "Giant Lobster", city: "Boothbay", state: "ME", description: "Huge lobster statue. Celebrates Maine's lobster industry.", latitude: 43.8765, longitude: -69.6337 },
    { name: "World's Largest Chest of Drawers", city: "High Point", state: "NC", description: "Giant bureau (dresser) building. High Point is the furniture capital.", latitude: 35.9557, longitude: -80.0053 },
    { name: "Giant Penguin", city: "Cut Bank", state: "MT", description: "27-foot penguin statue. 'Coldest spot in the nation' landmark.", latitude: 48.6333, longitude: -112.3333 },
