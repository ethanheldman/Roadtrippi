...
const ROADSIDE_AMERICA = {
  ...
  "Fremont Troll": {
    ...
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Fremont_Troll_2011.jpg/800px-Fremont_Troll_2011.jpg",
  },
...
// New Hampshire roadside attractions (per-city coordinates; images from Roadside America via scrape --state nh then backfill script)
const NH_ATTRACTIONS: SeedAttraction[] = [
  { name: "Rusty Mammoth", city: "Alstead", state: "NH", description: "New Hampshire roadside attraction in Alstead.", latitude: 43.15, longitude: -72.36 },
  { name: "New Hampshire Maple Museum", city: "Bethlehem", state: "NH", description: "New Hampshire roadside attraction in Bethlehem.", latitude: 44.28, longitude: -71.69 },
  { name: "Hannah Duston Massacre Site Statue", city: "Boscawen", state: "NH", description: "New Hampshire roadside attraction in Boscawen.", latitude: 43.31, longitude: -71.62 },
  { name: "Andres Sculpture Park - Forest of \"Huh?\"", city: "Brookline", state: "NH", description: "New Hampshire roadside attraction in Brookline.", latitude: 42.73, longitude: -71.66 },
  { name: "Big Lumberjack Carved From Tree", city: "Canaan", state: "NH", description: "New Hampshire roadside attraction in Canaan.", latitude: 43.65, longitude: -72.04 },
  { name: "Pirate Ship Paintball", city: "Center Barnstead", state: "NH", description: "New Hampshire roadside attraction in Center Barnstead.", latitude: 43.35, longitude: -71.25 },
  { name: "Stairway to Nowhere", city: "Chesterfield", state: "NH", description: "New Hampshire roadside attraction in Chesterfield.", latitude: 42.89, longitude: -72.47 },
  { name: "Victims of Carl Drega", city: "Colebrook", state: "NH", description: "New Hampshire roadside attraction in Colebrook.", latitude: 44.89, longitude: -71.5 },
  { name: "92-Foot-Tall Mercury Redstone Rocket Replica", city: "Concord", state: "NH", description: "New Hampshire roadside attraction in Concord.", latitude: 43.21, longitude: -71.54 },
  { name: "Christa McAuliffe: Shuttle Casualty", city: "Concord", state: "NH", description: "New Hampshire roadside attraction in Concord.", latitude: 43.21, longitude: -71.54 },
  { name: "Donkey Kong Mural", city: "Concord", state: "NH", description: "New Hampshire roadside attraction in Concord.", latitude: 43.21, longitude: -71.54 },
  { name: "Doorstep Defended by Franklin Pierce, Vacant Lot Where He Died", city: "Concord", state: "NH", description: "New Hampshire roadside attraction in Concord.", latitude: 43.21, longitude: -71.54 },
  { name: "Dress Worn by President Franklin Pierce", city: "Concord", state: "NH", description: "New Hampshire roadside attraction in Concord.", latitude: 43.21, longitude: -71.54 },
  { name: "Pedal A Rail Bike", city: "Concord", state: "NH", description: "New Hampshire roadside attraction in Concord.", latitude: 43.21, longitude: -71.54 },
  { name: "Statue of Franklin Pierce", city: "Concord", state: "NH", description: "New Hampshire roadside attraction in Concord.", latitude: 43.21, longitude: -71.54 },
  { name: "The Concord Clock", city: "Concord", state: "NH", description: "New Hampshire roadside attraction in Concord.", latitude: 43.21, longitude: -71.54 },
  { name: "Big Blue Mecha-Crab", city: "Dover", state: "NH", description: "New Hampshire roadside attraction in Dover.", latitude: 43.2, longitude: -70.87 },
  { name: "Ninja Turtles Manhole Cover and Marker", city: "Dover", state: "NH", description: "New Hampshire roadside attraction in Dover.", latitude: 43.2, longitude: -70.87 },
  { name: "Woodman Museum: Quirky Relics", city: "Dover", state: "NH", description: "New Hampshire roadside attraction in Dover.", latitude: 43.2, longitude: -70.87 },
  { name: "Old Man of the Mountain Profiler Plaza", city: "Franconia", state: "NH", description: "New Hampshire roadside attraction in Franconia.", latitude: 44.23, longitude: -71.75 },
  { name: "Miniature Trains within a Train", city: "Gorham", state: "NH", description: "New Hampshire roadside attraction in Gorham.", latitude: 44.39, longitude: -71.17 },
  { name: "Ruggles Mine", city: "Grafton", state: "NH", description: "New Hampshire roadside attraction in Grafton.", latitude: 43.56, longitude: -72.0 },
  { name: "Uncle Sam's Boyhood Home", city: "Greenville", state: "NH", description: "New Hampshire roadside attraction in Greenville.", latitude: 42.77, longitude: -71.81 },
  { name: "Beer Bottle on Church Steeple", city: "Hampton Falls", state: "NH", description: "New Hampshire roadside attraction in Hampton Falls.", latitude: 42.92, longitude: -70.86 },
  { name: "16-Foot-Tall Beach Santa", city: "Hampton", state: "NH", description: "New Hampshire roadside attraction in Hampton.", latitude: 42.94, longitude: -70.83 },
  { name: "Giant Pirate", city: "Hampton", state: "NH", description: "New Hampshire roadside attraction in Hampton.", latitude: 42.94, longitude: -70.83 },
  { name: "Hotel with Fake Lighthouse", city: "Hampton", state: "NH", description: "New Hampshire roadside attraction in Hampton.", latitude: 42.94, longitude: -70.83 },
  { name: "Memorial to a Witch", city: "Hampton", state: "NH", description: "New Hampshire roadside attraction in Hampton.", latitude: 42.94, longitude: -70.83 },
  { name: "Thorvald's Rock", city: "Hampton", state: "NH", description: "New Hampshire roadside attraction in Hampton.", latitude: 42.94, longitude: -70.83 },
  { name: "Birthplace of BASIC", city: "Hanover", state: "NH", description: "New Hampshire roadside attraction in Hanover.", latitude: 43.7, longitude: -72.29 },
  { name: "House Covered in License Plates", city: "Hinsdale", state: "NH", description: "New Hampshire roadside attraction in Hinsdale.", latitude: 42.79, longitude: -72.49 },
  { name: "Oldest Continuously Operating U.S. Post Office Building", city: "Hinsdale", state: "NH", description: "New Hampshire roadside attraction in Hinsdale.", latitude: 42.79, longitude: -72.49 },
  { name: "Deep Sea Diver and Dolphins", city: "Hooksett", state: "NH", description: "New Hampshire roadside attraction in Hooksett.", latitude: 43.1, longitude: -71.47 },
  { name: "Old Man of the Mountain Consolation Replica", city: "Hooksett", state: "NH", description: "New Hampshire roadside attraction in Hooksett.", latitude: 43.1, longitude: -71.47 },
  { name: "Ruined Monument to Man Saved by Pocahontas", city: "Isles of Shoals", state: "NH", description: "New Hampshire roadside attraction at Isles of Shoals.", latitude: 42.98, longitude: -70.61 },
  { name: "Mt. Washington Auto Road: Famous Bumper Sticker", city: "Jackson", state: "NH", description: "New Hampshire roadside attraction in Jackson.", latitude: 44.16, longitude: -71.18 },
  { name: "World's Worst Weather Museum", city: "Jackson", state: "NH", description: "New Hampshire roadside attraction in Jackson.", latitude: 44.16, longitude: -71.18 },
  { name: "Santa's Village", city: "Jefferson", state: "NH", description: "New Hampshire roadside attraction in Jefferson.", latitude: 44.42, longitude: -71.47 },
  { name: "Anti-Gravity Monument", city: "Keene", state: "NH", description: "New Hampshire roadside attraction in Keene.", latitude: 42.93, longitude: -72.28 },
  { name: "Jumanji: Parrish Shoes Mural", city: "Keene", state: "NH", description: "New Hampshire roadside attraction in Keene.", latitude: 42.93, longitude: -72.28 },
  { name: "Teacher's Desk Tombstone", city: "Keene", state: "NH", description: "New Hampshire roadside attraction in Keene.", latitude: 42.93, longitude: -72.28 },
  { name: "Carriage and Sleigh Museum", city: "Kingston", state: "NH", description: "New Hampshire roadside attraction in Kingston.", latitude: 42.94, longitude: -71.05 },
  { name: "Graves of Betty and Barney Hill", city: "Kingston", state: "NH", description: "New Hampshire roadside attraction in Kingston.", latitude: 42.94, longitude: -71.05 },
  { name: "36-Foot-Tall Indian Head", city: "Laconia", state: "NH", description: "New Hampshire roadside attraction in Laconia.", latitude: 43.53, longitude: -71.47 },
  { name: "American Classic Arcade Museum", city: "Laconia", state: "NH", description: "New Hampshire roadside attraction in Laconia.", latitude: 43.53, longitude: -71.47 },
  { name: "Abducted by Aliens", city: "Lincoln", state: "NH", description: "New Hampshire roadside attraction in Lincoln.", latitude: 44.05, longitude: -71.67 },
  { name: "Alien Abduction Gas Station", city: "Lincoln", state: "NH", description: "New Hampshire roadside attraction in Lincoln.", latitude: 44.05, longitude: -71.67 },
  { name: "Clark's Bears", city: "Lincoln", state: "NH", description: "New Hampshire roadside attraction in Lincoln.", latitude: 44.05, longitude: -71.67 },
  { name: "Indian Head Rock", city: "Lincoln", state: "NH", description: "New Hampshire roadside attraction in Lincoln.", latitude: 44.05, longitude: -71.67 },
  { name: "Mural: Ike's 1955 Visit", city: "Lincoln", state: "NH", description: "New Hampshire roadside attraction in Lincoln.", latitude: 44.05, longitude: -71.67 },
  { name: "Statue of Pollyanna", city: "Littleton", state: "NH", description: "New Hampshire roadside attraction in Littleton.", latitude: 44.31, longitude: -71.77 },
  { name: "Wallace Horse Cemetery", city: "Littleton", state: "NH", description: "New Hampshire roadside attraction in Littleton.", latitude: 44.31, longitude: -71.77 },
  { name: "Welded Robot Welder", city: "Littleton", state: "NH", description: "New Hampshire roadside attraction in Littleton.", latitude: 44.31, longitude: -71.77 },
  { name: "World's Longest Candy Counter - Chutter's", city: "Littleton", state: "NH", description: "New Hampshire roadside attraction in Littleton.", latitude: 44.31, longitude: -71.77 },
  { name: "Buffy The Dog Monument", city: "Londonderry", state: "NH", description: "New Hampshire roadside attraction in Londonderry.", latitude: 42.87, longitude: -71.37 },
  { name: "Giant Elvis Head and Pop Celebs", city: "Londonderry", state: "NH", description: "New Hampshire roadside attraction in Londonderry.", latitude: 42.87, longitude: -71.37 },
  { name: "America's Largest Glacial Traveler", city: "Madison", state: "NH", description: "New Hampshire roadside attraction in Madison.", latitude: 43.9, longitude: -71.15 },
  { name: "Grieving Gold Star Mother Statue", city: "Manchester", state: "NH", description: "New Hampshire roadside attraction in Manchester.", latitude: 42.99, longitude: -71.46 },
  { name: "Merci Box Car", city: "Manchester", state: "NH", description: "New Hampshire roadside attraction in Manchester.", latitude: 42.99, longitude: -71.46 },
  { name: "Mobile Advertising Elephant Statue", city: "Manchester", state: "NH", description: "New Hampshire roadside attraction in Manchester.", latitude: 42.99, longitude: -71.46 },
  { name: "Pencil Through a Building", city: "Manchester", state: "NH", description: "New Hampshire roadside attraction in Manchester.", latitude: 42.99, longitude: -71.46 },
  { name: "Sit With the Father of Video Games", city: "Manchester", state: "NH", description: "New Hampshire roadside attraction in Manchester.", latitude: 42.99, longitude: -71.46 },
  { name: "Bronze Archie: Ageless Teenager", city: "Meredith", state: "NH", description: "New Hampshire roadside attraction in Meredith.", latitude: 43.66, longitude: -71.5 },
  { name: "Swinging Footbridge", city: "Milford", state: "NH", description: "New Hampshire roadside attraction in Milford.", latitude: 42.83, longitude: -71.65 },
  { name: "Statue of Dog on Master's Grave", city: "Mont Vernon", state: "NH", description: "New Hampshire roadside attraction in Mont Vernon.", latitude: 42.89, longitude: -71.68 },
  { name: "Fort Stark, Decoy Ship Building", city: "New Castle", state: "NH", description: "New Hampshire roadside attraction in New Castle.", latitude: 43.07, longitude: -70.72 },
  { name: "Pose Inside Outdoor Picture Frame", city: "New Castle", state: "NH", description: "New Hampshire roadside attraction in New Castle.", latitude: 43.07, longitude: -70.72 },
  { name: "Loaf of Bread Tombstone", city: "New London", state: "NH", description: "New Hampshire roadside attraction in New London.", latitude: 43.41, longitude: -71.99 },
  { name: "Chicken Farmer Rock", city: "Newbury", state: "NH", description: "New Hampshire roadside attraction in Newbury.", latitude: 43.32, longitude: -72.04 },
  { name: "Thanksgiving Holiday Heroine", city: "Newport", state: "NH", description: "New Hampshire roadside attraction in Newport.", latitude: 43.37, longitude: -72.17 },
  { name: "Adventure Suites", city: "North Conway", state: "NH", description: "New Hampshire roadside attraction in North Conway.", latitude: 44.0, longitude: -71.13 },
  { name: "Kancamagus Collectibles and Car Museum", city: "North Woodstock", state: "NH", description: "New Hampshire roadside attraction in North Woodstock.", latitude: 44.03, longitude: -71.69 },
  { name: "Tiny Church - Rock of Ages", city: "North Woodstock", state: "NH", description: "New Hampshire roadside attraction in North Woodstock.", latitude: 44.03, longitude: -71.69 },
  { name: "Tilton Arch: An Unoccupied Tomb", city: "Northfield", state: "NH", description: "New Hampshire roadside attraction in Northfield.", latitude: 43.43, longitude: -71.59 },
  { name: "Wooden Lumberjack", city: "Orange", state: "NH", description: "New Hampshire roadside attraction in Orange.", latitude: 43.65, longitude: -72.1 },
  { name: "CCC Camp Museum", city: "Pembroke", state: "NH", description: "New Hampshire roadside attraction in Pembroke.", latitude: 43.15, longitude: -71.45 },
  { name: "Snowmobile Museum", city: "Pembroke", state: "NH", description: "New Hampshire roadside attraction in Pembroke.", latitude: 43.15, longitude: -71.45 },
  { name: "Border Monuments 18 Inches Apart", city: "Pittsburg", state: "NH", description: "New Hampshire roadside attraction in Pittsburg.", latitude: 45.05, longitude: -71.39 },
  { name: "Indian Village Attack Site", city: "Plymouth", state: "NH", description: "New Hampshire roadside attraction in Plymouth.", latitude: 43.76, longitude: -71.69 },
  { name: "African Burying Ground Memorial", city: "Portsmouth", state: "NH", description: "New Hampshire roadside attraction in Portsmouth.", latitude: 43.07, longitude: -70.76 },
  { name: "Massive Tidal Flows", city: "Portsmouth", state: "NH", description: "New Hampshire roadside attraction in Portsmouth.", latitude: 43.07, longitude: -70.76 },
  { name: "USS Albacore, Submarine in a Ditch", city: "Portsmouth", state: "NH", description: "New Hampshire roadside attraction in Portsmouth.", latitude: 43.07, longitude: -70.76 },
  { name: "Vintage Neon: Yoken's Whale", city: "Portsmouth", state: "NH", description: "New Hampshire roadside attraction in Portsmouth.", latitude: 43.07, longitude: -70.76 },
  { name: "Birthplace of President Garfield's Mom", city: "Richmond", state: "NH", description: "New Hampshire roadside attraction in Richmond.", latitude: 42.75, longitude: -72.27 },
  { name: "Polar Caves", city: "Rumney", state: "NH", description: "New Hampshire roadside attraction in Rumney.", latitude: 43.8, longitude: -71.81 },
  { name: "America's Stonehenge", city: "Salem", state: "NH", description: "New Hampshire roadside attraction in Salem.", latitude: 42.79, longitude: -71.2 },
  { name: "Giant Smoking Cigar Sign", city: "Salem", state: "NH", description: "New Hampshire roadside attraction in Salem.", latitude: 42.79, longitude: -71.2 },
  { name: "Great Wall of Sandwich", city: "Sandwich", state: "NH", description: "New Hampshire roadside attraction in Sandwich.", latitude: 43.8, longitude: -71.47 },
  { name: "KFC-Taco Bell Graveyard", city: "Somersworth", state: "NH", description: "New Hampshire roadside attraction in Somersworth.", latitude: 43.26, longitude: -70.86 },
  { name: "Only Town With a Real Redstone Missile", city: "Warren", state: "NH", description: "New Hampshire roadside attraction in Warren.", latitude: 43.92, longitude: -71.89 },
  { name: "Wright Museum of WWII History", city: "Wolfeboro", state: "NH", description: "New Hampshire roadside attraction in Wolfeboro.", latitude: 43.58, longitude: -71.21 },
];
